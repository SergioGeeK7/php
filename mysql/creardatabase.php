...
$conexion = mysql_connect("localhost","sergiohack","password","sergiohack"); // abre y guarda conexion
echo($conexion);
...
echo("Lo lograste <br/>");
/*
if (mysql_query("CREATE DATABASE primerabase ",$conexion))  // peticion a la base de datos ("la peticion")  ,$laquecontienelaconexion
{
...
mysql_select_db("primerabase",$conexion);  // seleccionar la base de datos con cual trabajar , $conexioin
